        ...
        <aside className="hidden md:flex flex-col w-[220px] bg-charcoal-950 flex-shrink-0">
            <div className="flex items-center gap-3 h-16 px-5 border-b border-white/5">
                ...
                <div>
                    ...
                    <div className="text-[9px] text-orange-400 font-bold uppercase tracking-[0.12em]">Admin Console</div>
                </div>
            </div>
            ...
            <nav className="flex-1 px-2.5 py-5 space-y-0.5">
                {NAV.map(({ label, href, exact, icon }) => {
                    ...
                    return (
                        ...
                        >
              <span className={`transition-colors flex-shrink-0 ${active ? 'text-white' : 'text-charcoal-500 group-hover:text-charcoal-200'}`}>
                {icon}
              </span>
                            {label}
                        </Link>
