...
function TrustBadge() {
    return (
        <div className="absolute bottom-8 right-8 sm:bottom-10 sm:right-10 z-20 pointer-events-none">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-4 py-3.5 shadow-2xl min-w-[160px]">
                ...
                <div className="font-display text-2xl font-bold text-white leading-none mb-0.5">150+</div>
                <div className="text-white/60 text-xs leading-snug">Diaspora families<br/>verified across Kenya</div>
            </div>
        </div>
    )
}
    ...
    return (
        <section className="relative   overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <div className="relative w-full rounded-3xl overflow-hidden" style={{ minHeight: 'min(96vh, 720px)' }}>
                    ...
                    {/* Gradient overlays — dark bottom-left for text, subtle top darkening */}
                    <div
              ...
              `,
                    ...
                    {/* Orange grid texture — very faint, same as site pattern */}
                    <div
                    ...
                    {/* ── Content — bottom left ─────────────────────────────────────────── */}
                    <div className="relative z-10 flex flex-col justify-end h-full p-7 sm:p-10 lg:p-14" style={{ minHeight: 'min(88vh, 640px)' }}>
                        <div className="max-w-xl">
                            ...
                            <div
                                ...
                                style={{ animation: 'hero-fade-up 0.65s 0.32s ease both' }}
                            >
                                {trustBadges.map(t => (
