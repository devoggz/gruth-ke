...
const CONTINENTS: [number, number][][] = [
    ...
    // Africa
    [
        [37,-6],[37,10],[33,12],[32,25],[30,33],[22,37],[16,41],[12,44],
        [8,44],[4,42],[0,42],[-5,40],[-10,38],[-17,36],[-25,34],[-34,26],
        [-34,18],[-27,15],[-17,12],[-10,14],[-5,10],[0,8],[4,2],[5,-2],
        [5,-8],[8,-13],[11,-15],[15,-17],[20,-17],[25,-15],[33,-8],[37,-6],
    ],

    // Europe (mainland + Iberia + Scandinavia simplified)
    [
        [36,-9],[36,5],[43,5],[44,8],[44,14],[42,18],[40,20],[38,22],
        [37,26],[38,27],[40,27],[41,30],[42,28],[44,30],[46,30],[47,24],
        [48,18],[48,15],[50,15],[54,18],[58,25],[63,28],[70,26],[71,22],
        [71,15],[65,14],[62,6],[58,5],[57,8],[56,10],[56,12],[58,12],
        [57,10],[55,8],[54,8],[55,10],[56,10],[57,10],[55,8],[54,8],
        [53,6],[52,4],[51,2],[51,-1],[50,-5],[48,-5],[44,-2],[43,3],
        [41,3],[40,0],[40,-4],[37,-9],[36,-9],
    ],

    // Asia (mainland — highly simplified)
    [
        [42,27],[42,36],[38,36],[37,36],[37,42],[35,36],[30,33],[26,37],
        [22,40],[15,42],[12,44],[8,44],[10,50],[12,52],[10,58],[14,74],
        [8,77],[8,80],[10,80],[13,80],[13,78],[18,73],[20,73],[22,68],
        [24,68],[22,60],[24,57],[23,57],[22,60],[24,66],[26,66],[28,64],
        [28,50],[25,52],[24,56],[23,58],[22,60],[24,68],[28,68],[32,74],
        [34,74],[36,72],[38,68],[40,60],[38,50],[36,46],[38,44],[40,50],
        [42,52],[44,50],[44,42],[44,36],[42,27],
    ],

    // East/Southeast Asia + Japan simplified arc
    [
        [40,120],[38,122],[36,122],[32,120],[28,120],[24,118],[22,114],
        [18,110],[14,108],[10,104],[4,104],[2,104],[1,104],[-1,110],
        [-6,107],[-8,115],[-8,125],[0,128],[4,118],[8,98],[14,100],
        [18,102],[22,106],[24,112],[28,116],[32,118],[36,120],[40,120],
    ],

    // North America
    [
        [72,-78],[70,-85],[70,-100],[72,-120],[70,-140],[60,-142],[58,-140],
        [55,-130],[50,-128],[48,-124],[46,-124],[40,-124],[36,-122],[32,-118],
        [28,-115],[24,-110],[22,-106],[22,-98],[25,-97],[30,-97],[30,-90],
        [26,-82],[24,-82],[18,-88],[16,-90],[15,-85],[8,-77],[8,-75],
        [10,-73],[15,-69],[18,-67],[22,-72],[26,-78],[30,-81],[34,-76],
        [36,-76],[38,-75],[40,-74],[42,-70],[44,-68],[44,-64],[47,-53],
        [52,-56],[52,-64],[56,-64],[62,-68],[68,-68],[70,-64],[72,-78],
    ],

    // Greenland (simplified)
    [
        [76,-68],[72,-54],[68,-54],[64,-40],[64,-22],[68,-18],[72,-20],
        [76,-30],[80,-30],[84,-40],[84,-58],[80,-64],[76,-68],
    ],

    // South America
    [
        [12,-72],[10,-62],[8,-60],[4,-52],[0,-50],[-4,-36],[-8,-35],
        [-10,-37],[-14,-39],[-20,-40],[-24,-44],[-28,-50],[-32,-52],
        [-34,-54],[-38,-58],[-42,-64],[-46,-66],[-50,-68],[-52,-68],
        [-54,-66],[-56,-67],[-54,-64],[-50,-62],[-46,-56],[-40,-50],
        [-34,-52],[-30,-50],[-24,-44],[-20,-42],[-16,-40],[-10,-38],
        [-4,-36],[0,-50],[4,-52],[8,-60],[10,-62],[12,-72],
        [10,-75],[2,-80],[-2,-80],[-4,-82],[-6,-78],[-4,-76],
        [0,-78],[4,-77],[8,-77],[12,-72],
    ],

    // Australia
    [
        [-14,126],[-14,136],[-12,136],[-12,136],[-14,136],[-16,136],
        [-14,126],[-14,122],[-16,118],[-20,118],[-22,114],[-28,114],
        [-32,116],[-34,118],[-36,136],[-38,140],[-38,148],[-36,150],
        [-34,152],[-32,152],[-28,154],[-24,152],[-22,150],[-18,148],
        [-16,146],[-14,144],[-12,142],[-14,136],[-14,126],
    ],

    // Antarctica (simplified arc — just the northern coast)
    [
        [-66,-180],[-68,-150],[-70,-120],[-68,-90],[-66,-60],[-68,-30],
        [-66,0],[-68,30],[-70,60],[-68,90],[-66,120],[-68,150],[-66,180],
    ],
]
...
function Globe() {
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < DOT_COUNT; i++) {
            ...
            const az  = golden * i
            dots.push({ x: Math.sin(inc) * Math.cos(az), y: Math.cos(inc), z: Math.sin(inc) * Math.sin(az) })
        }
        ...
        function draw() {
            ...
            continentVecs.forEach(poly => {
                ...
                const frontDepth = poly.reduce((sum, p) => sum + rotateX(p).z, 0) / poly.length
...
function ScrollIndicator() {
    return (
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce-slow pointer-events-none">
            <span className="text-charcoal-600 text-[10px] font-bold uppercase tracking-[0.2em]">Scroll</span>
    ...
    return (
        <section className="relative bg-charcoal-950 min-h-screen flex items-center overflow-hidden pt-16">
            ...
            <div className="absolute inset-0"
                 style={{ background: 'radial-gradient(ellipse 80% 70% at 22% 50%,transparent 0%,rgba(10,10,10,0.88) 72%)' }} />
            ...
            <div className="absolute right-0 top-0 bottom-0 w-[55%] hidden lg:flex items-center justify-center pointer-events-none">
                ...
                <div className="absolute inset-0 bg-transparent z-10" style={{ width: '35%' }} />
                <Globe />
            </div>
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
                <div className="max-w-xl lg:max-w-2xl">
                    ...
                    <h1 className="font-display text-5xl sm:text-6xl lg:text-[4.5rem] font-bold text-white leading-[1.04] mb-6 tracking-tight"
                    ...
                    <p className="text-charcoal-300 text-lg sm:text-xl leading-relaxed mb-12"
                       style={{ animation: 'hero-fade-up 0.7s 0.2s ease both' }}>
                        GRUTH sends an independent inspector to your site in Kenya.
                        You get documented evidence — not reassurances.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-x-6 gap-y-3"
                        ...
                        {trustBadges.map(t => (
                            <div key={t} className="flex items-center gap-2 text-charcoal-400 text-sm">
