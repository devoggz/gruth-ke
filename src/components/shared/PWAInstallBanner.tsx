        ...
        >
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <p className="text-sm font-bold text-charcoal-950 leading-tight">Install GRUTH</p>
            ...
            {mode === 'ios' && showIOSSteps && (
                        ...
                        {[
                            {
                                ...
                                text: (
                                    <>
                                        ...
                                        <span className="inline-flex align-middle text-orange-400"><IOSShareIcon /></span>{' '}
                ...
                <span className="w-6 h-6 rounded-full bg-orange-500 flex items-center justify-center text-white text-[11px] font-bold flex-shrink-0">
                  {step}
                                ...
                                <p className="text-charcoal-300 text-xs leading-relaxed">{text}</p>
                            </div>
                        ))}
                    </div>
