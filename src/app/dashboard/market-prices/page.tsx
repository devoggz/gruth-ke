    ...
    return (
        <div className="space-y-8 pb-12">
            ...
            <div className="rounded-xl border border-blue-200 bg-blue-50 px-5 py-4 flex gap-3">
                ...
                <div>
                    <p className="text-sm font-semibold text-blue-800">How prices are sourced</p>
                    <p className="text-xs text-blue-600 mt-0.5 leading-relaxed">
                        Prices are sourced from leading hardware suppliers in each county, verified by GRUTH
                        field inspectors, and updated weekly. Use these as a reference when reviewing contractor
                        quotes — a significant markup (30%+) from these figures is a red flag.
                    </p>
                </div>
            </div>
            ...
            {counties.length === 0 ? (
                <div className="card p-16 text-center">
                    ...
                    <p className="text-charcoal-500 text-sm">
                        Our team is compiling verified prices across all 47 counties. Check back shortly.
                    </p>
                </div>
            ) : (
                <MarketPricesClient
