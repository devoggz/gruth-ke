...
export default async function InspectorDashboardPage() {
    ...
    const upcoming  = accepted.filter(p => p.inspections[0]?.status === 'SCHEDULED')
        ...
        <div className="space-y-8">
            <div>
                ...
                <p className="text-charcoal-500 text-sm mt-1">
                    ...
                    {upcoming.length} scheduled inspection{upcoming.length !== 1 ? 's' : ''}
              ...
              <span className="w-1.5 h-1.5 bg-white/60 rounded-full animate-pulse"/>
                    ...
                    <div className="space-y-3">
                      ...
                      Action required
                                    ...
                                    <p className="text-charcoal-500 text-sm mt-0.5">{p.location}</p>
            ...
            <div className="grid grid-cols-3 gap-4">
                {[
                    { label: 'Assigned',  value: accepted.length,  color: 'bg-charcoal-950 text-white' },
            ...
            <div>
                ...
                {accepted.length === 0 ? (
                    <div className="card p-10 text-center">
                        <p className="text-charcoal-400">No active projects yet. Accept an assignment above to get started.</p>
                    </div>
                ) : (
                    <div className="space-y-3">
                        {accepted.map(p => (
