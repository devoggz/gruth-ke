...
export const SERVICES: Service[] = [
...

    {
        ...
        description: 'Weddings, funerals, graduations, family gatherings — we place a trusted agent on the ground to monitor, document, and relay your most important moments in real time.',
        ...
        deliverable: 'Event readiness report pre-event + a photo/video summary delivered same day.',
        ideal:       'Diaspora families who cannot be present but need assurance their most important milestones are witnessed, honoured, and documented.',
    },
