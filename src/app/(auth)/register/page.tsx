      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-charcoal-500 text-sm">Start monitoring your Kenyan investments</p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs text-charcoal-400 font-medium">or with email</span>
            <div className="flex-1 h-px bg-charcoal-100" />
          </div>
          ...
          <p className="text-center text-xs text-charcoal-400 mt-4 leading-relaxed">
            ...
            <Link href="/terms" className="text-charcoal-600 hover:text-orange-600 underline underline-offset-2">Terms</Link>
            {' '}and{' '}
            <Link href="/privacy" className="text-charcoal-600 hover:text-orange-600 underline underline-offset-2">Privacy Policy</Link>
          </p>
